...
##==============================================================================
save(store_info_seoul, file = here::here("inst", "extdata", "store_info_seoul.rda"))
save(store_info_gyeonggi, file = here::here("inst", "extdata", "store_info_gyeonggi.rda"))
save(store_info_middle, file = here::here("inst", "extdata", "store_info_middle.rda"))
save(store_info_south, file = here::here("inst", "extdata", "store_info_south.rda"))
